            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-striped" id="table-1">
                  <thead>
                   <tr bgcolor="#E1E1E1">
 <th><div align="center"><strong>ID Ganti</strong></div></th>
    <th><div align="center"><strong>ID Barang</strong></div></th>
	<th><div align="center"><strong>NIB</strong></div></th>
    <th><div align="center"><strong>NIP</strong></div></th>
    <th><div align="center"><strong>ID Pengganti</strong></div></th>
    <th><div align="center"><strong>Keterangan</strong></div></th>
    <th><div align="center"><strong>Tanggal Ganti</strong></div></th>
    <th><div align="center"><strong>Petugas</strong></div></th>
    <th colspan="2"><div align="center"><strong>Option</strong></div></th>  </tr>
                  </thead>
                  <tbody>
                    <?php
                    $no = 1; 
                    $query = "SELECT * FROM ganti";

                    $exe = mysqli_query($conn, $query);
                    $total = mysqli_num_rows($exe);
                    while ($row = mysqli_fetch_array($exe)) 
                    	while ($row = mysqli_fetch_array($exe)) {
                      $id_ganti = $row['id_ganti'];
                      ?>
	
                      
                      <tr onmouseover="this.className='on'" onmouseout="this.className='out'">
   <td id="tbody"><?php echo $row['id_ganti']?></td>
	<td id="tbody"><?php echo $row['id_barang']?></td>
	<td id="tbody"><?php echo $row['NIB']?></td>
	<td id="tbody"><?php echo $row['nip']?></td>
    <td id="tbody"><?php echo $row['id_barang_pengganti']?></td>
    <td id="tbody"><?php echo $row['ket']?></td>
	<td id="tbody"><?php echo $row['tgl_ganti']?></td>
    <td id="tbody"><?php echo $row['petugas']?></td>
