        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
            	<table width="881">
            		<tr>
				    <td width="242" height="27"><H4>Data Rusak</H4></td>
              ...
              <div class="card-header-action">
               ...
               <div class="card-header-action">
                 <button type="button" href="cari_barang.php" class="btn btn-secondary">Detail</button>
				</div>  		                     
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-striped" id="table-1">
                  <thead>
                   <tr bgcolor="#E1E1E1">
    <th><div align="center"><strong>ID Rusak</strong></div></th>
    <th><div align="center"><strong>ID Barang</strong></div></th>
	<th><div align="center"><strong>Nama Barang</strong></div></th>
    <th><div align="center"><strong>Nama Pelapor</strong></div></th>
    <th><div align="center"><strong>Penerima Laporan</strong></div></th>
    <th><div align="center"><strong>Tanggal Lapor</strong></div></th>
    <th><div align="center"><strong>Deskripsi Kerusakan</strong></div></th>
    <th><div align="center"><strong>Petugas Penyerahan</strong></div></th>
    <th><div align="center"><strong>Petugas Perbaikan</strong></div></th>
    <th><div align="center"><strong>Level Kerusakan</strong></div></th>
    <th colspan="2"><div align="center"><strong>Penanganan</strong></div></th>
     <th colspan="3"><div align="center"><strong>Option</strong></div></th>
  </tr>
                  </thead>
                  <tbody>
                    <?php
                    $no = 1; 
                    $query = "SELECT t.*,b.merk,p.nama
FROM rusak t
inner JOIN barang b ON t.id_barang = b.id_barang
inner join pegawai p on t.nip=p.nip
ORDER BY t.id_rusak ASC";
$query = "select r.*, p.nama_pegawai,b.merk,
p.id_unitkerja, u.unitkerja from rusak r, barang b, m_pegawai p, m_unitkerja u where p.nipbaru=r.nip 
and r.id_barang=b.id_barang and p.id_unitkerja=u.id";
                    ...
                    while ($row = mysqli_fetch_array($exe)) {
                      ...
                      $tgl_lapor = $row['tgl_lapor'];
	$tgl_lapor1 = date('d-m-Y', strtotime($tgl_lapor ));
	
                      ?>
                      <tr onmouseover="this.className='on'" onmouseout="this.className='out'">
   <td id="tbody"><?php echo $row['id_rusak']?></td>
	<td id="tbody"><?php echo $row['id_barang']?></td>
	<td id="tbody"><?php echo $row['merk']?></td>
	<td id="tbody"><?php echo $row['nama_pegawai']?></td>
    <td id="tbody"><?php echo $row['petugas_penerima']?></td>
    <td id="tbody"><?php echo $tgl_lapor1; ?></td>
	<td id="tbody"><?php echo $row['deskripsi_rusak']?></td>
	<td id="tbody"><?php echo $row['petugas_kembali']?></td>
	<td id="tbody"><?php echo $row['petugas_perbaikan']?></td>
    <td id="tbody"><?php echo $row['level']?></td>
	<td id="tbody"><?php echo $row['penanganan']?></td>
