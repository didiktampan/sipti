              ...
              <div class="table-responsive">
                <table class="table table-striped" id="table-1">
                  ...
                  <tbody>
	                    <?php
	                    $no = 1; 
	                    $query = "SELECT * FROM m_pegawai order by id_unitkerja desc";
                      ...
                      <tr>                       
                        ...
                        <td id="tbody" valign="middle" align="center"><a href="edit_pegawai.php?id=<?php echo $data['nip']; ?>"><img src="gambar/Ubah.png"></a></td>
    					<td id="tbody" valign="middle" align="center"><a href="hapus_pegawai.php?id=<?php echo $data['nip']; ?>"><img src="gambar/Hapus.png"></a></td>
                      </tr>
                      <?php
                    } 
                    ?>
