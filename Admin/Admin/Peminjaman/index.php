  ...
  <section class="section">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
            	<table width="881">
            		<tr>
				    <td width="242" height="27"><H4>Data Pegawai</H4></td>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-striped" id="table-1">
                  <thead>
                   <tr bgcolor="#E1E1E1">
    <th><div align="center"><strong>ID Pinjam</strong></div></th>
   
	<th><div align="center"><strong>Nama</strong></div></th>
    <th><div align="center"><strong>Tanggal Pinjam</strong></div></th>
	 <th><div align="center"><strong>Rencana Kembali</strong></div></th>
    <th><div align="center"><strong>Keperluan</strong></div></th>
	<th><div align="center"><strong>ID Barang</strong></div></th>
    <th><div align="center"><strong>Nama Barang</strong></div></th>
    <th><div align="center"><strong>Petugas Pemberi</strong></div></th>
    <th><div align="center"><strong>Tanggal Kembali</strong></div></th>
    <th><div align="center"><strong>Petugas Penerima</strong></div></th>
    <th colspan="3"><div align="center"><strong>Option</strong></div></th>
                  ...
                  <tbody>
                    <?php
                    $no = 1; 
                    $query = "SELECT t.*,b.merk,p.nama_pegawai
FROM pinjam_kembali t
inner JOIN barang b ON t.id_barang = b.id_barang
inner join m_pegawai p on t.nip=p.nipbaru
ORDER BY t.id_pinjam ASC";
                    $exe = mysqli_query($conn, $query);
                    $total = mysqli_num_rows($exe);
                    while ($row = mysqli_fetch_array($exe)) {
                      $id_pinjam = $row['id_pinjam'];
                      $tgl_pinjam=$row['tgl_pinjam'];
	$tgl_pinjam1 = date('d-m-Y', strtotime($tgl_pinjam ));
	
                      ?>
                      <tr onmouseover="this.className='on'" onmouseout="this.className='out'">
    <td id="tbody"><?php echo $row['id_pinjam']?></td>
	<td id="tbody" style="display:none"><?php echo $row['nip']?></td>
	<td id="tbody"><?php echo $row['nama_pegawai']?></td>
	<td id="tbody"><?php echo $tgl_pinjam1; ?></td>
	<td id="tbody">
	<?php 
	$tgl_rencana_kembali=$row['tgl_rencana_kembali'];
	$tgl_rencana_kembali1 = date('d-m-Y', strtotime($tgl_rencana_kembali));
	
	if ($row['tgl_rencana_kembali'] == ""){
		echo " ";
	} elseif ($row['tgl_rencana_kembali'] == "0000-00-00"){
		echo " ";
	} else {
		echo $tgl_rencana_kembali1;
	}
	?></td>
    <td id="tbody"><?php echo $row['keperluan']?></td>
	<td id="tbody"><?php echo $row['id_barang']?></td>
    <td id="tbody"><?php echo $row['merk']?></td>
	<td id="tbody"><?php echo $row['petugas_pemberi']?></td>
    <td id="tbody">
	<?php
	$tgl_kembali=$row['tgl_kembali'];
	$tgl_kembali1 = date('d-m-Y', strtotime($tgl_kembali ));

	if ($row['tgl_kembali'] == ""){
		echo " ";
	} elseif ($row['tgl_kembali'] == "0000-00-00"){
		echo " ";
	} else {
		echo $tgl_kembali1;
	}
