...
<div class="main-content">
   ...
   while ($row=mysqli_fetch_array($sql))
  {
	...
	#ubah format tanggal
	$tgl_perolehan=$row['tahun_perolehan'];
                    ...
                    while ($row = mysqli_fetch_array($exe)) {
                      ...
                      <tr>
				        ...
				        <td><?php echo $row['pemegang']; ?></td>
				           <td id="tbody" valign="middle" align="center"><a href="edit_barang.php?id=<?php echo $data['id_barang']; ?>"><img src="gambar/Ubah.png"></a></td>
    <td id="tbody" valign="middle" align="center"><a href="hapus_barang.php?id=<?php echo $data['id_barang']; ?>"><img src="gambar/Hapus.png" /></a></td>
