...
<?php
	#jml laptop
	$sql = mysqli_query ($conn, "select * from barang where id_jenis ='UPS'");
	$jml_ups = mysqli_num_rows($sql);

	#jml laptop
	$p = mysqli_query ($conn, "select * from barang where id_jenis ='UPS' and status='1'");
	$dipinjam = mysqli_num_rows($p);
	
	#jml laptop
	$q = mysqli_query ($conn, "select * from barang where id_jenis ='UPS' and status='0'");
	$free = mysqli_num_rows($q);
	
	#jml laptop
	$q = mysqli_query ($conn, "select * from barang where id_jenis ='UPS' and status='2'");
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
            	<table width="881">
            		<tr>
				    <td width="242" height="27"><H4>Jumlah UPS</H4></td>
				    <td width="11"><H4>:</H4></td>
				    <td width="612"><H4><?php echo $jml_ups;?></H4></td>
				   </tr>
				   <tr>
				    <td width="242" height="27"><H4>Jumlah UPS Dipinjam</H4></td>
				    <td width="11"><H4>:</H4></td>
				    <td width="612"><H4><?php echo $dipinjam;?></H4></td>
				   </tr>
				   <tr>
				    <td width="242" height="27"><H4>Jumlah UPS Free</H4></td>
				    <td width="11"><H4>:</H4></td>
				    <td width="612"><H4><?php echo $free;?></H4></td>
				  </tr>
				  <tr>
				    <td width="242" height="27"><H4>Jumlah UPS Terpakai</H4></td>
				    <td width="11"><H4>:</H4></td>
              ...
              <div class="table-responsive">
                <table class="table table-striped" id="table-1">
                  ...
                  <tbody>
                    <?php
                    $no = 1; 
                    $query = "SELECT * FROM barang where id_jenis='UPS' ORDER BY id_barang ASC";
