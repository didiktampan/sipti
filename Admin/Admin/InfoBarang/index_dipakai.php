...
<?php
#jml perangkat terpakai
	$sql = mysqli_query ($conn, "select * from barang where status='2'");
	$jml_pakai = mysqli_num_rows($sql);
	?>
<div class="main-content">
  <section class="section">
    <div class="section-header">
      <h1>Data Perangkat Dipakai</h1>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4>Jumlah Perangkat Yang Dipakai</h4>
              <h4><?php echo $jml_pakai;?></h4>
              ...
              <div class="table-responsive">
                <table class="table table-striped" id="table-1">
                  ...
                  <tbody>
                    <?php
                    $no = 1; 
                    $query = "SELECT * FROM barang where status='2' ORDER BY id_barang ASC";
