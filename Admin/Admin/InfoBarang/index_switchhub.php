...
<?php
	#jml laptop
	$sql = mysqli_query ($conn, "select * from barang where id_jenis ='SH'");
	$jml_switch = mysqli_num_rows($sql);

	#jml laptop
	$p = mysqli_query ($conn, "select * from barang where id_jenis ='SH' and status='1'");
	$dipinjam = mysqli_num_rows($p);
	
	#jml laptop
	$q = mysqli_query ($conn, "select * from barang where id_jenis ='SH' and status='0'");
	$free = mysqli_num_rows($q);
	
	#jml laptop
	$q = mysqli_query ($conn, "select * from barang where id_jenis ='SH' and status='2'");
...
<div class="main-content">
  <section class="section">
    <div class="section-header">
      <h1>Data Perangkat Switch Hub</h1>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
            	<table width="881">
            		<tr>
				    <td width="242" height="27"><H4>Jumlah Switch Hub</H4></td>
				    <td width="11"><H4>:</H4></td>
				    <td width="612"><H4><?php echo $jml_switch;?></H4></td>
				   </tr>
				   <tr>
				    <td width="242" height="27"><H4>Jumlah Switch Hub Dipinjam</H4></td>
				    <td width="11"><H4>:</H4></td>
				    <td width="612"><H4><?php echo $dipinjam;?></H4></td>
				   </tr>
				   <tr>
				    <td width="242" height="27"><H4>Jumlah Switch Hub Free</H4></td>
				    <td width="11"><H4>:</H4></td>
				    <td width="612"><H4><?php echo $free;?></H4></td>
				  </tr>
				  <tr>
				    <td width="242" height="27"><H4>Jumlah Switch Hub Terpakai</H4></td>
				    <td width="11"><H4>:</H4></td>
              ...
              <div class="table-responsive">
                <table class="table table-striped" id="table-1">
                  ...
                  <tbody>
                    <?php
                    $no = 1; 
                    $query = "SELECT * FROM barang where id_jenis='SH' ORDER BY id_barang ASC";
