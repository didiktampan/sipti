      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
			...
			Cari Data : <input type="text" name="q" id="q" class="search" placeholder="Search..." required/> <input type="submit" value="Search" class="button"/>
			</form></td>
				  </tr>
				</table>
			</div>
...
if(isset($_GET['q']) && $_GET['q']){
	...
	//mysql_select_db("sippti");
	include '../../koneksi.php';
	$q = $_GET['q'];
	$sql = "select * from barang where id_barang like '%$q%' or 
	id_jenis like '%$q%' or merk like '%$q%' or tahun_perolehan like '%$q%' or asal like '%$q%' or NIB like '%$q%' or serial_number like '%$q%' or ket like '%$q%' or
	status like '%$q%' or lokasi like '%$q%' or pemegang like '%$q%'";
...
<div class="card-header-action">
			...
			{
				#ubah format tanggal
				$tgl_perolehan=$data['tahun_perolehan'];
				$format = date('d-m-Y', strtotime($tgl_perolehan ));
			?>
			<tbody>
  			<tr onmouseover="this.className='on'" onmouseout="this.className='out'">
				<td id="tbody"><?php echo $data['id_barang'];?></td>
				<td id="tbody"><?php echo $data['id_jenis'];?></td>
                <td id="tbody"><?php echo $data['merk'];?></td>
				<td id="tbody"><?php echo $data['tahun_perolehan']?></td>
                <td id="tbody"><?php echo $data['asal'];?></td>
				<td id="tbody"><?php echo $data['NIB'];?></td>
				<td id="tbody"><?php echo $data['serial_number'];?></td>
                <td id="tbody"><?php echo $data['ket'];?></td>
				<td id="tbody">
				<?php
					if ($data['status'] == "0"){
					echo "Free";
                ...
                ?></td>
                <td id="tbody" valign="middle" align="center"><a href="edit_barang.php?id=<?php echo $data['id_barang']; ?>">
                	<img src="gambar/Ubah.png"></a></td>
            	<td id="tbody" valign="middle" align="center"><a href="hapus_barang.php?id=<?php echo $data['id_barang']; ?>">
                	<img src="gambar/Hapus.png"></a></td>
 			 </tr>
			<?php }?>
		</tbody>
		</table>
